...
1. **Intro** — Leis de idade mínima são o instrumento global contra casamento infantil, mas
   onde a união informal domina elas regulam a margem errada; o Brasil 2019 é o caso
   extremo e nós o avaliamos com desenho congelado ex ante.
...
6. **Behavior (PNADC + SINASC)** — A PNADC não identifica redução da prevalência de
   ...
   −23,9% sem tendência; trata-se de faixa de especificações, não intervalo causal.
7. **Robustness** — Placebos, janelas, sexo, DDD de exposição (não identifica), sintético.
